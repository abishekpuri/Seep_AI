...
if __name__ == "__main__":
    ...
    while currentGame < maxGameplay:
        ...
        Ai.scoresHistory = []
        MCTSNN.winRateHistory = []
        start_time = time.time()
        history, hmScore, aiScore, hmScoreHis, aiScoreHis = playGame(nn)
        ...
        gameStat = pd.DataFrame({'Expectiminimax scores':Ai.scoresHistory, 'Expectiminimax game scores':hmScoreHis, 'MCTS win rates':MCTSNN.winRateHistory, 'MCTS game scores':aiScoreHis})
